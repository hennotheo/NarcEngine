...
namespace narc_engine {
    DeviceQueueService::DeviceQueueService(NARC_DI_IMPORT_COMPONENT(ISurfacesHandler)) :
        NARC_DI_IMPL_COMPONENT(ISurfacesHandler, m_surfacesManager)
    {
    ...
    bool DeviceQueueService::queueFamilyIndexSupportPresentation(const ISurface* surface, const VkPhysicalDevice& physicalDevice,
