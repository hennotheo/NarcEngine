...
#define NARC_DECL_RHI_PLATFORM_GETTER(className, platform) NARC_VIRTUAL_GETTER(className##platform*, className##platform, nullptr)
...
#define NARC_IMPL_RHI_PLATFORM_GETTER(className, platform) NARC_OVERRIDE_GETTER(className##platform*, className##platform, const_cast<ContextVulkan*>(this))
